...
public:
     ...
     * sphincsplus:
     */
    static const unsigned int SIZE            = SPX_SK_BYTES;
...
private:
    ...
    using KeyType = std::array<unsigned char, SPX_SK_BYTES>;
...
public:
    ...
    // bool VerifyPubKey2(const CPubKey& vchPubKey) const;
